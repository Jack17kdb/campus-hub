  ...
  return (
    <div className="flex flex-col space-y-6 p-4">
      ...
      <div className="flex justify-center">
        <div className="w-24 h-5 bg-gray-400 rounded-full animate-pulse"></div>
      </div>
            ...
            >
              ...
              >
                <div className="space-y-2">
                  ...
                  <div
                    className={`h-3 bg-gray-300 rounded ${
                      isOutgoing ? "w-32" : "w-40"
                    }`}
                  ></div>
                  {i % 2 === 0 && (
                    <div
                      className={`h-3 bg-gray-300 rounded ${
                        isOutgoing ? "w-24" : "w-36"
                      }`}
                    ></div>
                  )}
                </div>
              ...
              {/* Timestamp skeleton */}
              <div
                className={`h-2 w-16 bg-gray-500 rounded animate-pulse ${
                  isOutgoing ? "ml-auto" : ""
                }`}
              ></div>
            </div>
